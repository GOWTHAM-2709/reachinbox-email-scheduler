...
export const Search = () => {
  ...
  return (
    <div className="p-4 sm:p-6">
        ...
        <div className="flex gap-2">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="block w-full pl-10 pr-9 py-2.5 text-sm border border-slate-700 rounded-xl bg-slate-900/90 text-white placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500 transition-all"
      ...
      {error && (
        <div className="p-4 mb-4 rounded-xl bg-rose-500/10 text-rose-400 text-sm border border-rose-500/20">
          {error}
        </div>
      )}
